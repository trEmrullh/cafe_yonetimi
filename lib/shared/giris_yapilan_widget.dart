...
import 'package:LAST_SUMMER_COFFE/screens/urun_yonetim_screen.dart';
import 'package:LAST_SUMMER_COFFE/shared/my_page_route.dart';
...
InkWell gunSonunuGor(WidgetRef ref, BuildContext context) {
  return InkWell(
    borderRadius: BorderRadius.circular(10),
    onTap: () async {
      await ref.read(gunSonuControllerProvider).gunSonunuGetir();
      ref.read(gunSonuControllerProvider).bugunBilgisi();
                ...
                content: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        gunSonuControllerConsumer.gunBilgisi,
                        style: TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.bold,
                        ),
